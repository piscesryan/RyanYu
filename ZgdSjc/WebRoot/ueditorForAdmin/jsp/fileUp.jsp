    ...
    up.setSavePath("upload/admin/files"); //保存路径
    String[] fileType = {".rar" , ".doc" , ".docx" , ".xls" , ".zip" , ".pdf" , ".txt" , ".swf", ".wmv", ".avi", ".rm", ".rmvb", ".mpeg", ".mpg", ".ogg", ".mov", ".wmv", ".mp4"};  //允许的文件类型
